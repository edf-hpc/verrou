...
static void vr_post_clo_init(void)
{
   ...
   interflop_set_handler("strncpy", _interflop_valgrind_strncpy);
...
static void vr_pre_clo_init(void)
{
   ...
   VG_(details_copyright_author)(
      "Copyright (C) 2014-2019, EDF (F. Fevotte & B. Lathuiliere). 2019-2026, EDF (B. Lathuiliere). 2020-2021, TriScale innov (F. Fevotte)\n ");
