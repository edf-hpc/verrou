...
if __name__=="__main__":
    roundingTab =["UPWARD", "DOWNWARD", "FARTHEST", "ZERO", "AWAY_ZERO", "FLOAT"]
    ...
    genFlopImpl(handler, roundingmode="NEAREST")
    ...
    for rounding in ["NEAREST"]+roundingTab:
        if rounding!="NEAREST":
            handler.write("#ifdef USE_VERROU_OPTIM\n")
