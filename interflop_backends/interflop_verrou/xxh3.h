...
//      xxh_u32 const input2 = XXH_readLE32(((void*)input) + len - 4);
      static xxh_u64 const ksecretContrib=(XXH_readLE64(XXH3_kSecret+8) ^ XXH_readLE64(XXH3_kSecret+16));
...
XXH3_64bits_withSeed(const float * input,  XXH64_hash_t seed)
{
   ...
   seed ^= (xxh_u64)XXH_swap32((xxh_u32)seed) << 32;
   {
      xxh_u32 const input1 = *((xxh_u32*)input);
...
inline void update_pre_computed_bitflip( XXH64_hash_t seed){
   ...
   xxh_u64 const pre_computed_bitflip = ksecretContrib - seed;
}
