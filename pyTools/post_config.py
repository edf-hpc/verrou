...
class postConfig:
    ...
    def registerOptions(self):
        ...
        self.registryTab+=[("rounding","string", "POST_ROUNDING",     ["--rounding=", "--rounding-mode="] ,[] , ["all_det","no_det","random","average","nearest","upward","downward", "farthest", "toward_zero","random_det","average_det"], True)]
    ...
    def normalize(self):
        ...
        if "no_det" in self.rounding:
            ...
            self.rounding+=["random","average", "random_det"]
