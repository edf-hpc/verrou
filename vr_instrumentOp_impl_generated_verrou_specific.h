...
if(vr.roundingMode==VR_NEAREST ||  vr.roundingMode==VR_NATIVE){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_RANDOM){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_AVERAGE){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_RANDOM_DET){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_AVERAGE_DET){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_RANDOM_COMDET){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_AVERAGE_COMDET){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_RANDOM_SCOMDET){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_AVERAGE_SCOMDET){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_SR_MONOTONIC){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_SR_SMONOTONIC){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_UPWARD){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_DOWNWARD){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_ZERO){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_AWAY_ZERO){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_FARTHEST){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_FLOAT){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_PRANDOM){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_PRANDOM_DET){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
...
if(vr.roundingMode==VR_PRANDOM_COMDET){	if(vr.instrument_soft_used){
	if(!vr.float_conv){
