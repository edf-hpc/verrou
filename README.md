...
download a specific Valgrind version, and patch it. Fetch valgrind's sources:
    ...
    git clone --branch=VALGRIND_3_21_0 --single-branch git://sourceware.org/git/valgrind.git valgrind-3.21.0+verrou-dev
...
or if you have proxy problem with git:// protocol:
    ...
    tar xvfj valgrind-3.21.0.tar.bz2
    mv valgrind-3.21.0 valgrind-3.21.0+verrou-dev


Add verrou's sources to it:

    cd valgrind-3.21.0+verrou-dev
