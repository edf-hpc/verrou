...
static VG_REGPARM(3) void FCTNAME(64Fx2,Fallback)(/*OUT*/V128* output, ULong aHi, ULong aLo, ULong bHi,ULong bLo) {
  double arg1[2] = {*((double*)(&aLo)),*((double*)(&aHi))} ;
  double arg2[2] = {*((double*)(&bLo)),*((double*)(&bHi))} ;
  double* res=(double*) output;
  (BACKENDFUNC(double))(arg1[0], arg2[0], res, backend_context);
...
static VG_REGPARM(3) void FCTNAME(64Fx4,Fallback) (/*OUT*/V256* output,
							 ULong b0, ULong b1, ULong b2,ULong b3) {
  double arg2[4] = {*((double*)(&b0)),*((double*)(&b1)), *((double*)(&b2)),*((double*)(&b3))} ;
  double* res=(double*) output;
  for(int i=0; i<4; i++){
...
static VG_REGPARM(3) void FCTNAME(32Fx8,FallBack) (/*OUT*/V256* output,
						ULong b0, ULong b1, ULong b2,ULong b3) {
...
static VG_REGPARM(3) void FCTNAME(32Fx4,Fallback) (/*OUT*/V128* output, ULong aHi, ULong aLo, ULong bHi,ULong bLo) {
  V128 reg1; reg1.w64[0]=aLo; reg1.w64[1]=aHi;
  V128 reg2; reg2.w64[0]=bLo; reg2.w64[1]=bHi;
